...
//if user has already registered. it take the user to account page
...
if(isset($_POST['register'])) {
  ...
  if ($password !== $confirmPassword) {
    ...
    if ($num_rows != 0) {
      ...
      //if there is no user register with this email before
    } else {
            ...
            <form id="register-form" method="POST" action="register.php">
              <p style="color: red;"><?php if(isset($_GET['error'])){ echo $_GET['error']; } ?></p>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="register-confirm-password" name="confirmPassword" placeholder="Re-type Password" required>
                </div>
